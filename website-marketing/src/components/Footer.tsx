      ...
      <div className="container">
        <div className="footer-grid">
          ...
          <div className="footer-brand">
            ...
            <p>
              Powerful task management platform designed to help teams collaborate, 
        ...
        <div className="footer-bottom">
          <p>© {new Date().getFullYear()} BiTi Technologies. All rights reserved.</p>
          <div style={{ display: 'flex', gap: '1.5rem' }}>
            ...
            <a href="#" aria-label="GitHub" style={{ color: 'var(--text-muted)' }}>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
            ...
            <a href="#" aria-label="LinkedIn" style={{ color: 'var(--text-muted)' }}>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
